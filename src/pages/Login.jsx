    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[48%] gradient-mesh noise relative overflow-hidden flex-col justify-between p-12">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute -top-32 -left-24 w-[480px] h-[480px] rounded-full blur-[130px]" style={{ background: 'rgba(37,99,235,0.14)' }} />
            ...
            {[
              ...
              <div key={t.name} className="glass-dark rounded-[16px] p-4 border border-white/[0.07]">
                ...
                <div className="flex items-center gap-2 mt-3">
                  <div className="w-6 h-6 rounded-lg bg-blue-600 flex items-center justify-center text-white text-[10px] font-bold">{t.name[0]}</div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-white">
        <motion.div
          ...
          <div className="mb-8">
            <h2 className="font-extrabold text-[#0A1628] mb-1.5" style={{ fontSize: '1.875rem', letterSpacing: '-0.03em' }}>Sign in</h2>
            <p className="text-[#6B7A99] text-[14px]">Enter your credentials to continue</p>
          </div>

          {error && (
            <motion.div initial={{ opacity: 0, y: -6 }} animate={{ opacity: 1, y: 0 }}
              className="mb-5 flex items-start gap-3 p-3.5 bg-red-50 border border-red-100 rounded-[14px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-[12.5px] font-bold text-[#3D4F72] mb-2 uppercase tracking-[0.06em]">Email</label>
              <input
            ...
            <div>
              <label className="block text-[12.5px] font-bold text-[#3D4F72] mb-2 uppercase tracking-[0.06em]">Password</label>
            ...
            <button
              ...
              className="w-full h-[50px] bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-[14px] transition-all disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-2"
          ...
          <div className="mt-7 pt-6 border-t border-[#E4EAF4] text-center">
            <p className="text-[#6B7A99] text-[13px]">
              Don't have an account?{' '}
              <Link to="/register" className="text-blue-600 font-bold hover:text-blue-700 transition-colors no-min-h">
                Create one free
              </Link>
            </p>
          </div>
          ...
          <div className="mt-6 flex items-center justify-center gap-4">
            {['Anonymous','Moderated','Secure'].map(t => (
              <div key={t} className="flex items-center gap-1 text-[#9AAAC7] text-[11px] font-medium">
